...
import { resolveCascaderSearchLabel } from "@qr-manager/ui/components/reui/cascader/cascader-i18n";
import {
...
export interface CascaderBackProps
...
export interface CascaderBreadcrumbProps
  extends Omit<useRender.ComponentProps<"nav">, "children"> {
...
export interface CascaderValueProps
...
function CascaderValue({
  ...
  const resolvedPath =
    selectedValues.length === 1
      ? getCascaderPath(index, selectedValues[0])
      : [];
