  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-primary absolute top-0 left-0 -translate-x-1/2 rounded-b-none shadow-xs"
        style={{ width: 5 }}
      />
    </div>
  );
...
function DataGridTableLoader() {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <div className="text-muted-foreground bg-card flex items-center gap-2 rounded-none border px-4 py-2 text-sm leading-none font-medium">
...
function DataGridTableRowPin<TData extends object>({
  ...
  return (
    <button
      ...
      className={cn(
        "text-muted-foreground hover:text-foreground inline-flex size-7 items-center justify-center rounded-none transition-colors",
    ...
    >
      {row.getCanExpand() ? (
        <button
          ...
          className={cn(
            "text-muted-foreground hover:text-foreground inline-flex items-center justify-center rounded-none transition-colors",
            controlSize,
          )}
        >
          {children ?? (
